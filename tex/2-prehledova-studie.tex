...
Další analyzovaný online kurz \emph{Introduction to Data Analytics}\footnote{Systematickou analýzu kurzu uvádíme v~tabulce s~parametry viz Tabulka \ref{tab6}.} spadá pod platformu Coursera a~je součástí čtyř na sebe navazujících e-learningů, které jsou zarámované profesním certifikátem \emph{IBM Data Analyst Professional Certificate} (certifikát se snaží reflektovat požadavky na pracovní trh, které dle predikci předpovídají až 20\% nárust
