...
\tightlist
\item
  \emph{zjištění nedostatku znalostí v~dané oblasti};
\item
  \emph{rozpoznání informační a~datové potřeby k~dosažení konkrétního cíle a~definování limitů této potřeby};
\item
  \emph{identifikování typu informace, který nejlépe vyhovuje k~naplnění dané potřeby}.
\end{itemize}
